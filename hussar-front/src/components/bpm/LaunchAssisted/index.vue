...
<template>
  <el-dialog
    ...
    class="launchAssisted-dialog lcdp-dialog jxd_additional lcdp_axe theme-config-front"
    :visible.sync="launchAssistedShow"
    title="发起协办"
    width="694px"
    :append-to-body="true"
  ...
  >
    <div class="launchAssisted-dialog-body">
      <div class="launchAssisted-dialog-body-right">
        <!-- 参与者 -->
        <div class="launchAssisted-dialog-body-row cyz">
          <div class="launchAssisted-dialog-body-row-left">参与者</div>
          <div class="launchAssisted-dialog-body-row-right">
            <el-select
              v-model="selTags"
        ...
        <!-- 协办原因 -->
        <div class="launchAssisted-dialog-body-row-x xzyy">
          <div class="launchAssisted-dialog-body-row-left-x">协办原因</div>
          <div class="launchAssisted-dialog-body-row-right-x">
            <!-- 协办原因输入框 -->
  ...
  methods: {
    ...
    handleSave() {
      ...
      if (!isEmpty) {
        ...
        hussarRequest.postJson(workFlowApi.createAssistTask, data).then((res) => {
          if (res.code === 200 || res.code === 10000) {
            ...
            self.$emit('showLaunchAssistedExecuteFunction');
            HussarRouter.showMsg(this, '发起协办成功', 'success');
            self.handleClose();
          } else {
