...
<template>
  ...
  >
    ...
    <div slot="footer" class="dialog-footer">
      <el-button class="dialog-cancel jxd_ins_elButton default" @click="handleClose">{{
        $t("common.cancel")
      }}</el-button>
      <el-button class="dialog-save jxd_ins_elButton default" type="primary" @click="confirmSelect">{{
        $t("common.confirm")
      }}</el-button>
    </div>
  </el-dialog>
...
export default {
  ...
  props: {
    consignorDialogVisible: Boolean,
    selectionBackup: Object
  },
  components: {
    VueEasyTree
  },
    ...
    consignorDialogVisible: {
      handler(n) {
        ...
        if (this.$refs.multipleTable) {
          this.$refs.multipleTable.setCurrentRow(this.selectionBackup);
        }
      },
      deep: true
    },
