<template>
  <div class="pwdMain theme-forgetPwd">
    <el-row class="form">
      ...
      <el-col :offset="8" :span="8">
        ...
        <div v-if="isShow.div1">
          <el-form :model="form1" :rules="rules" ref="accountForm">
            <el-form-item :label-width="labelWidth" :label="$t('navbar.loginAccount')" prop="account">
              <el-input :placeholder="$t('userManage.loginText')" v-model.trim="form1.account" />
            </el-form-item>
            <el-form-item :label-width="labelWidth" label="验证码" prop="kaptcha">
              ...
              >
                <template slot="append"><img
                  style="width: 80px; height: 34px;cursor: pointer;"
                  :src="kaptchaUrl"
                  @click="getKaptcha"
                ></template>
              </el-input>
            ...
            <div class="editBtn-bottoms">
              <el-button @click="cancel" class="forgetPaw btn-cancel forgetPwd-cancel">{{ $t('common.cancel') }}</el-button>
              <el-button @click="stepOne" class="forgetPaw-save btn-save forgetPwd-save" type="primary" style="margin-left: 10px">{{ $t('login.forgetPwd.next') }}</el-button>
            </div>
          </el-form>
        </div>
        ...
        <div v-if="isShow.div2">
          <el-form :model="form2" :rules="rules" ref="answerForm">
            ...
            <div class="editBtn-bottoms">
              <el-button @click="cancel" class="forgetPaw btn-cancel forgetPwd-cancel">{{ $t('common.cancel') }}</el-button>
              <el-button @click="stepTwo" class="forgetPaw-save btn-save forgetPwd-save" type="primary" style="margin-left: 10px">{{ $t('login.forgetPwd.next') }}</el-button>
            </div>
          </el-form>
        </div>
        ...
        <div v-if="isShow.div3">
          <el-form :model="form3" :rules="rules" ref="pwdForm">
            ...
            <div class="editBtn-bottoms">
              <el-button @click="cancel" class="forgetPaw btn-cancel forgetPwd-cancel">{{ $t('common.cancel') }}</el-button>
              <el-button @click="stepThree" class="forgetPaw-save btn-save forgetPwd-save" type="primary" style="margin-left: 10px">{{ $t('common.save') }}</el-button>
            </div>
          </el-form>
        </div>
...
<style scoped>
    ...
    .forgetPaw-save{width: 68px; padding: 0 8px; line-height: unset; border: unset; background-color: var(--c-themeColor) !important;}

    .theme-forgetPwd .forgetPwd-save:focus, .theme-forgetPwd .forgetPwd-save:hover {
        background-color: var(--c-themeColor) !important;
        opacity: 0.65;
    }
    .theme-forgetPwd .forgetPwd-cancel {
        background-color: #FFF;
        color: #878787;
    }
    .theme-forgetPwd .forgetPwd-cancel:focus, .theme-forgetPwd .forgetPwd-cancel:hover {
        border-color: var(--c-themeColor) !important;
        color: var(--c-themeColor) !important;
    }
    .theme-forgetPwd ::v-deep .el-input__inner:hover, .theme-forgetPwd ::v-deep .el-input__inner:focus {
        border-color: var(--c-themeColor) !important;
    }
</style>
