<template>
  <div class="login-container1 business-login center-layout" :style="`background: ${background}`">
    <div class="login-bg-area">
      <div class="login-bg-content" :style="`background: ${innerBackground}`">
        <div class="logo-title login-title">
          <blob-img v-if="personalizedConfig.logo" :src="personalizedConfig.logo" alt="" />
          <img v-else src="@/assets/business/login/logo2.png">
          <span class="title_wel">{{ personalizedConfig.sysname }}</span>
        </div>
      </div>
    </div>
    <div class="login-box center-box">
      <div class="logo-title">
        <span class="title_wel login_title_wel">登录</span>
      </div>
      <el-form
        ref="loginFormRef"
        :model="loginForm"
      ...
      >
        ...
        <el-form-item prop="kaptcha" v-if="showKaptcha" class="Verification-code">
          <el-input
            type="text"
          ...
          >
            ...
            <template slot="append"><img class="verify-code" :src="kaptchaUrl"
                                         @click="getKaptcha"
            ></template>
          </el-input>
        </el-form-item>
        <el-form-item prop="totp" v-if="showTotp">
          <el-input
            type="text"
    ...
    <div class="login-footer" v-if="personalizedConfig.copyright != '-1'">Copyright &#169;
